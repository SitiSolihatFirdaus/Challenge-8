...
import { AiOutlineUser, AiOutlineMail, AiTwotoneHome } from "react-icons/ai"
    ...
    <div className='w-full h-screen'>
      ...
      />
        <div className='bg-black/60 fixed top-0 left-0 w-full h-screen'></div>
          ...
          <div className='max-w-[450px] h-[800] mx-auto mt-10 bg-black/75 text-white'>
            <div className='max-w-[320px] mx-auto py-6'>
              ...
              {!token ? (
                ...
                <Link to='/'>
                  <button className='w-full bg-red-600 py-3 my-6 rounded-3xl font-bold' type="submit">Register</button>
                </Link>
